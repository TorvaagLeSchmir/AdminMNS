...
public class Infos {
    ...
    private String copie_id;
    private String cv;
    private String copie_diplome;
    private String bulletins_notes;
    ...
    public String getCopie_id() {
        return copie_id;
    }

    public void setCopie_id(String copie_id) {
    ...
    public String getCopie_diplome() {
        return copie_diplome;
    }

    public void setCopie_diplome(String copie_diplome) {
        this.copie_diplome = copie_diplome;
    }

    public String getBulletins_notes() {
        return bulletins_notes;
    }

    public void setBulletins_notes(String bulletins_notes) {
